...
def categorize_scoutsuite_error(stderr: str) -> str:
    ...
    if "initialization failure" in stderr_lower and "credentials do not have access" in stderr_lower:
        return "Azure: Service principal has no access to any subscriptions"
